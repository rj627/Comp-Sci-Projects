...
public class HeapMain 
{
	...
	public static void main(String[] args) 
	{
		...
		HeapUtils.remove(intArray, 11);
		new HeapDisplay().displayHeap(intArray, 10);
		
		HeapUtils.insert(intArray, new Integer(234), 11);
		new HeapDisplay().displayHeap(intArray, 12);
	} //close main()
